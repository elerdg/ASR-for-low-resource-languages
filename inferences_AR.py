...
tokenizer = Wav2Vec2CTCTokenizer.from_pretrained("/data/disk1/data/erodegher/wav2vec2-large-xls-r-300m-arabic-80/checkpoint-10780/", local_files_only = True)
...
## import test set 
common_voice_test= load_dataset("common_voice", "ar", data_dir="./cv-corpus-6.1-2020-12-11", split="test[:40%]")
...
common_voice_transcription= load_dataset("common_voice", "ar", split="test[:40%]")
